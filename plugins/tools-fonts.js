const fuentes = [
  ...
  {
    name: 'BOLD SCRIPT',
    upper: '𝓐𝓑𝓒𝓓𝓔𝓕𝓖𝓗𝓘𝓙𝓚𝓛𝓜𝓝𝓞𝓟𝓠𝓡𝓢𝓣𝓤𝓥𝓦𝓧𝓨𝓩'.replace(/./g,(c,i)=>'𝓐𝓑𝓒𝓓𝓔𝓕𝓖𝓗𝓘𝓙𝓚𝓛𝓜𝓝𝓞𝓟𝓠𝓡𝓢𝓣𝓤𝓥𝓦𝓧𝓨𝓩'[i]),
    lower: '𝓪𝓫𝓬𝓭𝓮𝓯𝓰𝓱𝓲𝓳𝓴𝓵𝓶𝓷𝓸𝓹𝓺𝓻𝓼𝓽𝓾𝓿𝔀𝔁𝔂𝔃'.replace(/./g,(c,i)=>'𝓪𝓫𝓬𝓭𝓮𝓯𝓰𝓱𝓲𝓳𝓴𝓵𝓶𝓷𝓸𝓹𝓺𝓻𝓼𝓽𝓾𝓿𝔀𝔁𝔂𝔃'[i])
  },
  {
    name: 'MONOSPACE',
...
for (let fuente of fuentes) {
  ...
  const aToz = 'abcdefghijklmnopqrstuvwxyz'
  for (let i = 0; i < 26; i++) {
    fuente.map[AtoZ[i]] = fuente.upper[i]
    fuente.map[aToz[i]] = fuente.lower[i]
  }
}
