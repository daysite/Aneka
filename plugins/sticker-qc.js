...
text = m.quoted.text;
} else return conn.reply(m.chat, `*${xsticker} Por favor, ingresa o responde a un texto para realizar tu sticker.*`, m, rcanal);
if (!text) return conn.reply(m.chat, `*${xsticker} Agrega un texto.*`, m);
